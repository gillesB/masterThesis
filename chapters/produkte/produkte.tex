...
Fahrbahnbegrenzungen, Böschungen, Mauern, Bahngleise und Zäune, aber auch Balkone oder die Geschosszahl von Gebäuden.	
 \autocite[vgl.][]{wupp-alkis} Ein Beispieldokment kann unter \vref{fig:stadtgrundkarte} gefunden werden. \\
	...
	Schätzungskarte (NRW)
	&
	Die Schätzungskarte ist \enquote{eine auf der Grundlage der Flurkarte hergestellte Einzelkarte, in der zusätzlich die Schätzungsergebnisse der Reichsbodenschätzung eingetragen sind.}  \autocite{gg-schaetzungskarte}
						
	\enquote{Die Kennzeichnung aller landwirtschaftlich nutzbaren Bodenflächen nach der Bodenbeschaffenheit durch Einteilung in Klassen (Bestandsaufnahme) und die Feststellung ihrer Ertragsfähigkeit aufgrund der natürlichen Ertragsbedingungen durch Ermittlung von Wertzahlen (eigentliche Schätzung). Gestartet im Jahr 1934. Auch heute noch wertvolle Datenquelle in ökologischen und Landwirtschaftsanwendungen von GIS.} \autocite{gg-reichsbodenschaetzung} \\
	...
	\enquote{Die Lagefestpunkte bilden in ihrer Gesamtheit das Lagefestpunktfeld mit einer Punktdichte je nach Bundesland von 1 Festpunkt auf 1 - 5 $km^2$. Das Lagefestpunktfeld dient heute noch überwiegend als Grundlage für alle amtlichen Vermessungen, insbesondere der Katastervermessung und der topographischen Landesaufnahme.} \autocite{adv-lagefestpunkte}\\
	\hline
	Punktnachweis (PDF)
	&
