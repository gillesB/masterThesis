...
\begin{longtable}{|p{0.3\textwidth}|p{0.642\textwidth}|}
	...
	Flurkarte (NRW)
	&
	"`Der "`Auszug aus dem Liegenschaftskataster - Flurkarte NRW"'  ist eine landesweit einheitliche Ausgabe aus dem Grunddatenbestand. Er enthält alle Flurstücke, Gebäude und Nutzungsarten ohne weitere topographische Inhalte."' \autocite{wupp-alkis} In \acs{WuNDa} wird die Flurkarte auch Liegenschaftskarte genannt, ein Beispieldokument kann unter \ref{fig:flurkarte} gefunden werden.\\
	\hline
