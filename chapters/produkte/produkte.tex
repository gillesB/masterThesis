...
In diesem Kapitel werden die Produkte aufgelistet, welche die externen Benutzer selbst beziehen können. Diese Produkte sind in vier Produktklassen eingeteilt:
\begin{itemize}
...
\begin{longtable}{|p{0.3\textwidth}|p{0.7\textwidth}|}
	...
	&
	Erweiterung von Bestandsnachweis (NRW) \\
	\hline
...
Obwohl es sich nicht um Standardausgaben handelt sind einige dieser Produkte vermessungsrelevant und somit in bestimmten Situation für den ÖbVI gebührenfrei.
...
Die erste Aufgabe an Ort und Stelle ist das Untersuchen der alten Grenzen und dem Aufsuchen der bereits vorhandenen Abmarkungen (Grenzsteine etc.).
Danach kann der Lageanschluss über \acs{SAPOS} durchgeführt werden. Beim handelt es sich um einen "`Anschluss einer Vermessung an das amtliche Bezugskoordinatensystem"', dieser "`wird durch differenzielle Beobachtung von Navigationssatelliten realisiert"'.
\acs{SAPOS} steht für \acl{SAPOS} und ermöglicht eine deutschlandweite Positionsbestimmung mittels Satelliten \autocite[vgl.][2]{sapos-prospekt}. \todo{AP-Karten und AP-Übersichten werden normalerweise nur für Kontrollpunkte benötigt, ggfls. für die örtliche Grenzuntersuchung.}
