...
Die Baulasten für ein Grundstück bleiben auch nach einem Eigentümerwechsel bestehen und können nur dann gelöscht werden, falls zwischenzeitliche Ereignisse eingetreten sind, wodurch das Bauvorhaben auch ohne Baulast baurechtskonform ist \autocite[vgl.][]{herne-baulasten}.
...
Demnach ist ein Erhalten dieser Informationen wichtig, insbesondere da sie in späteren Phasen des Projektes vorhanden sein müssen.
...
Danach kann eine kostenfreie mündliche oder telefonische Auskunft erhalten werden, diese Auskunft kann schriftlich bestätigt werden, d.\,h. man erhält einen schriftlichen Auszug  aus dem Baulastenverzeichnis.
Ist eine Baulast auf dem Grundstück vorhanden, so kostet diese Auskunft \EUR{50} bis \EUR{150}.
Ist keine Baulast vorhanden, dann kostet eine schriftliche Bescheinigung \EUR{10}.
