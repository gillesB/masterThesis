...
Aus diesem Grund soll der Bericht lediglich in den Masken vorgesehen werden und ein Beispielbericht soll auch generiert werden können. Dieser entspricht allerdings nicht den tatsächlichen Geschäftsstatistiken.
