...
In einem ersten Schritt wurden die bereits vorhandenen, benötigten Cids"=Klassen betrachtet. Hierbei wurde festgestellt, dass einzig die Cids"=Klasse der Buchungen, die \inline{BILLING}"=Klasse vorhanden ist. Diese Klasse ist in der \autoref{fig:db-billing} abgebildet.
\begin{figure}[htb]
	\centering
