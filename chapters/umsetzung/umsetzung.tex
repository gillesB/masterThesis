...
\todo{Werden sie wirklich besser beschrieben?}
...
Der Hauptzweck dieses Entwicklungsumfeldes ist das Erstellen von Informationssystemen, insbesondere \acp{GIS}.
...
Dabei kann VerDIS auf Informationen aus \ac{WuNDa} zurück greifen.
...
Ein Vorteile dieser Herangehensweise ist die Aktualität des Katalogs, da dieser zu jedem Zeitpunkt neu erstellt werden kann.
...
Weiterhin können die Informationen bezüglich jeden Knotens angezeigt, so z.\,B. die vergebenen Rechten und ihre SQL-Query.
Diese Informationen können auch für die nicht dynamisch erstellten Knoten verändert werden.
Eine weitere Funktionalität ist das Anlegen und Verwalten der verschiedenen Berechtigungen für die Benutzer.
Da diese Funktionalität des \ac{ABF} eine wichtige Rolle in dieser Arbeit spielen, werden sie im Folgenden näher beleuchtet. 
...
Im Folgenden sollen einige Besonderheiten des Datenbankmodell hervorgehoben werden.
...
\begin{wrapfigure}{o}{0.4\textwidth}
  ...
  \caption{Datumsauswahl} \label{fig:jxdatepicker} 
\end{wrapfigure}
...
Somit wird beim Starten des Programmes das \inline{TakeoffHook} \inline{JXDatePickerHeaderTakeoff} ausgeführt, das die zwei Zeilen aus \autoref{lst:setHead} beinhaltet.\\
...
Allerdings konnte bei den Felder für die Produkte und Kundengruppen auf die Drag-and-Drop Funktionalität der Cids-Umgebung zurückgegriffen werden.
...
Diesen Berichte können aus Java heraus dynamisch generiert werden, indem ihnen Parameter und Listen übergeben werden.
Bei den Parametern handelt es sich um normale Java-Objekte, die im Bericht weiterverarbeitet und angezeigt werden können.
Über die mitgegebenen Listen kann im Bericht iteriert werden und deren Elemente können ebenfalls weiterverarbeitet werden.
