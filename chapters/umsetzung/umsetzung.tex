...
In einem ersten Schritt wurden die bereits vorhandenen, benötigten Klassen betrachtet. Hierbei wurde festgestellt, dass einzig die Klasse der Buchungen, die Billing-Klasse vorhanden ist. Diese Klasse ist in der \myfig{fig:db-billing} zu sehen.
\todo{beschreiben}
\begin{figure}[htb]
	\centering
